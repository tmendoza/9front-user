...
{
	/* Peach */
	mkcol(0, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF);
	/* Aqua */
	mkcol(1, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF);
	/* Yellow */
	mkcol(2, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF);
	/* Green */
	mkcol(3, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF);
	/* Blue */
	mkcol(4, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF);
	/* Grey */
