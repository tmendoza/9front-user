...
main(int, char**)
{
	...
	back = allocimagemix(display, DBlack, DBlack);

	hrhand = allocimage(display, Rect(0,0,1,1), CMAP8, 1, DDarkgreen);
	minhand = allocimage(display, Rect(0,0,1,1), CMAP8, 1, DPalegreen);
	dots = allocimage(display, Rect(0,0,1,1), CMAP8, 1, DGreen);
	redraw(screen);
